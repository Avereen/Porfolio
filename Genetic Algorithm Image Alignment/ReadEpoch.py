...
def getSurfaceProps(population,dimsamp):
    ...
    dim = sum([dims[0]**.5,dims[1]**.5])/2
    designs = population.generateDesign(popOrder[0])
    sa1 = im.surfaceArea2(designs[0], rangex=(0,dim*dimsamp[0]), rangey=(0,dim*dimsamp[1]),resolution=1000)
    sa2 = im.surfaceArea2(designs[1], rangex=(0,dim*dimsamp[0]), rangey=(0,dim*dimsamp[1]),resolution=1000)
    return sa1, sa2

epochs_set=[3]#,70,100,100,100,100]#,100,100,100,100,100,100,100,100,100,100]
