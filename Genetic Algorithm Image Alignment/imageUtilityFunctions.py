...
def plot_2curfall2(ims,color_map=cm.gray):
    ...
    sclmap=mpl.cm.ScalarMappable(norm=mpl.colors.Normalize(vmax=dmax,vmin=dmin))
    diffmap=mpl.cm.ScalarMappable(norm=mpl.colors.Normalize(vmax=dmax_diff,vmin=dmin_diff))
